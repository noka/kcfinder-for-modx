...
$_CONFIG['maxImageWidth']   = intval($modx->config['image_limit_width']);
//$_CONFIG['maxImageHeight']  = 960;
$_CONFIG['thumbWidth']      = 100;
$_CONFIG['thumbHeight']     = 100;
$_CONFIG['thumbsDir']       = '.thumbs';
$_CONFIG['jpegQuality']     = 90;
